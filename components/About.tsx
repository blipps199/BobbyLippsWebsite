        ...
        <section id="about" className="dark-bg">
            <div className="flex">
                ...
                <div className="flex-full about-text">
                    ...
                    <br/>
                    <a className="green" href="https://bobby-lipps-website-assets.s3.amazonaws.com/Bobby-Lipps-Resume-Cloud-Frontend-Developer.pdf" target="_blank">View My Resume(PDF)</a>
                </div>
            </div>
